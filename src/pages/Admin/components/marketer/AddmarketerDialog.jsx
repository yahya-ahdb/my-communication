...
export default function AddmarketerDialog() {
    ...
    const handleEditeCategroy = async () => {
        ...
        await axios.post( apiUrl + `createMarketer`, formData ,{headers: { ...headers, "Content-Type": "multipart/form-data" }}).then( () => {
    ...
    return (
        <div>
            ...
            <Dialog open={ open } onClose={ handleClose } >
                <DialogTitle style={ { direction: "rtl" } }>إنشاء حساب مسوق جديد</DialogTitle>
