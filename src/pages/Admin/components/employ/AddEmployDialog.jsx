...
export default function AddEmployDialog() {
    ...
    const handleEditeCategroy = async () => {
        ...
        await axios.post( apiUrl + `createEmployee`, formData, {headers: { ...headers, "Content-Type": "multipart/form-data" }} ).then( () => {
    ...
    return (
        <div>
            ...
            <Dialog open={ open } onClose={ handleClose } >
                <DialogTitle style={ { direction: "rtl" } }>إنشاء حساب موظف جديد</DialogTitle>
